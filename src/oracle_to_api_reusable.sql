CREATE OR REPLACE FUNCTION call_llm_api(p_prompt_instructions VARCHAR2, p_data VARCHAR2, p_model VARCHAR2, p_api_url VARCHAR2) RETURN VARCHAR2 IS
...
BEGIN
    ...
    l_http_request := UTL_HTTP.begin_request(p_api_url, 'POST', 'HTTP/1.1');
